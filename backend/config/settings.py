...
SECRET_KEY = 'django-insecure-1$b%amvkmyv6!%5l=s51ymciqezcqrwg1$*ep6=6#_ivah2=zw'
DEBUG = True
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'secure_docs_db'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for enforcing strict MAC, DAC, RBAC, RuBAC, and ABAC access controls.',
    'VERSION': '1.0.0',
